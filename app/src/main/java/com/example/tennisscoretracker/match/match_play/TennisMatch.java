...
public class TennisMatch {
     ...
     *
     * @param setNumber the number of the set we want to retrieve.
     * @return the result as a string in the format gamesWon_team1-gamesWon_team2.
     * Returns null if setNumber > this.getSetsCompleted().
     */
    public String getPreviousSetResult(int setNumber) {
        return (setNumber > previousSetResults.size()) ? null : previousSetResults.get(setNumber - 1);
    }
    ...
    public int getCurrentSetNumber() {
        ...
        return (this.winningTeamNumber != 0) ? MATCH_IS_FINISHED : setsCompleted + 1;
    }
