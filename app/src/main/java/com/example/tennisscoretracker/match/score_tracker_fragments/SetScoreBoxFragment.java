 ...
 */
public class SetScoreBoxFragment extends Fragment {
    ...
    public static SetScoreBoxFragment newInstance(String topText, String bottomText) {
        SetScoreBoxFragment fragment = new SetScoreBoxFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_set_scorebox, container, false);
    ...
    private void setText(View v, String topText, String bottomText) {
        ...
        TextView topTextView = v.findViewById(R.id.fragment_set_scorebox_TOP_TEXTVIEW);
        TextView bottomTextView = v.findViewById(R.id.fragment_set_scorebox_BOTTOM_TEXTVIEW);
