...
public class PlayerNameFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_playername_scorebox, container, false);
    ...
    private void setText(View v, String topText, String bottomText) {
        ...
        TextView topTextView = v.findViewById(R.id.fragment_playername_scorebox_TOP_TEXTVIEW);
        TextView bottomTextView = v.findViewById(R.id.fragment_playername_scorebox_BOTTOM_TEXTVIEW);
